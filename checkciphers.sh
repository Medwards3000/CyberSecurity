...
# Can be used in conjuction with "nmap -sV --script ssl-enum-ciphers -p 443 -iL network_subnets.list >cipherslist.txt". Just comment first line and remove comment from second line.
#Result:
